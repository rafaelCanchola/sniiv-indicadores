export const ind_b1 = {
    "Nombre": "1.1 Porcentaje de viviendas en rezago habitacional en el país, respecto al total de viviendas",
    ...
    "Definición o descripción": "Medición del porcentaje de viviendas en rezago habitacional. El indicador de rezago habitacional se construye a partir de tres componentes principales como establece CONAVI: 1) materiales deteriorados, 2) materiales regulares, y 3) precariedad en espacios. La medición de este indicador permitirá dar seguimiento al número de viviendas que logran salir del rezago.",
    ...
    "APLICACIÓN DEL MÉTODO DE CÁLCULO DEL INDICADOR PARA LA OBTENCIÓN DEL VALOR DE LA LÍNEA BASE":
    {
        "variables":[
            {
                "Nombre variable":"1.- VFRH =Viviendas en rezago en 2018",
                "Valor variable": 9409845,
                "Fuente de información variable": "ENIGH",
            },
            {
                "Nombre variable":"2.- TV = Total de viviendas en 2018",
                "Valor variable": 34155615,
                "Fuente de información variable": "ENIGH",
            },
        ],
        "Sustitución en método de cálculo del indicador": "PVRH= (9409845/34155615)*100=27.54\nNúmero de viviendas en rezago: 27.54% viviendas en rezago como porcentaje del total de viviendas\nPVRH = (VFRH/TV)*100"
    },
