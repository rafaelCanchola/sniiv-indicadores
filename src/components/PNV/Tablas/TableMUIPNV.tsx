                ...
                <TableContainer component={Paper}>
                    ...
                    <Table className={classes.table} id={props.id} >
                        <TableBody >
                            ...
                            <TableRow><TableCell className={classes.head} align={"center"} colSpan={9}>{childKeys[0]}</TableCell></TableRow>
                            ...
                            <TableRow>
                                ...
                                <TableCell className={classes.body} align={"center"} colSpan={5}>{props.data[childKeys[0]][variableslast]}</TableCell>
                            </TableRow>
                            <TableRow><TableCell className={classes.head} align={"center"} colSpan={9}>{childKeys[1]}</TableCell></TableRow>
                            <TableRow>
                            ...
                            <TableRow>
                                ...
                                <TableCell className={classes.body} align={"center"} colSpan={2}>{props.data[childKeys[1]][lineaMap[0]][baseMap[0]].toLocaleString()}</TableCell>
                            ...
                            <TableRow>
                                ...
                                <TableCell className={classes.body} align={"center"} colSpan={2}>{props.data[childKeys[1]][lineaMap[0]][baseMap[1]]}</TableCell>
                            </TableRow>
                            <TableRow>
                            ...
                            <TableRow>
                                <TableCell className={classes.body} align={"center"} colSpan={4}>{props.data[childKeys[1]][lineaMap[2]].toLocaleString()}</TableCell>
                                <TableCell className={classes.body} align={"center"} colSpan={5}>{props.data[childKeys[1]][lineaMap[3]]}</TableCell>
                            </TableRow>
                            <TableRow><TableCell align={"center"} className={classes.head} colSpan={9}>{childKeys[2]}</TableCell></TableRow>
                            <TableRow>
